...
export interface TrmrkEditableTextBoxMagnifierProps {
  text: string;
}

export default function TrmrkEditableTextBoxMagnifier(
  props: TrmrkEditableTextBoxMagnifierProps
) {
  return (<div className="trmrk-textbox-magnifier trmrk-editable-textbox-magnifier">
