...
export interface TrmrkEditableMultilineTextMagnifierProps {
  text: string;
}

export default function TrmrkEditableMultilineTextMagnifier(
  props: TrmrkEditableMultilineTextMagnifierProps
) {
  return (<div className="trmrk-text-magnifier trmrk-editable-multiline-text-magnifier">
