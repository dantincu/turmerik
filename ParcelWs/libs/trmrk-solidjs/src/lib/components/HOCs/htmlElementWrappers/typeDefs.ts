/*
Source: pasted from node_modules\solid-js\types\jsx.d.ts
*/
...
export namespace JSX {
  ...
  export interface BoundEventHandler<
    T,
    E extends Event,
  ...
  > = EventHandlerUnion<T, E, InputEventHandler<T, E>>;
  ...
  export type ChangeEventHandlerUnion<T, E extends Event> = EventHandlerUnion<
    T,
    E,
  ...
  export interface ExplicitBoolAttributes {}
  ...
  export type OnCaptureAttributes<T> = {
  ...
  export interface CustomEventHandlersCamelCase<T> {
  ...
  export interface CustomEventHandlersNamespaced<T> {
  ...
  export interface HTMLSlotElementAttributes<T = HTMLSlotElement>
  ...
  export interface TemplateHTMLAttributes<T extends HTMLTemplateElement>
    extends HTMLAttributes<T> {
  ...
  export interface CoreSVGAttributes<T>
  ...
  export interface GraphicsElementSVGAttributes<T>
    extends CoreSVGAttributes<T>,
      Pick<
        ...
        | "color-rendering"
      > {}
  export interface LightSourceElementSVGAttributes<T>
    extends CoreSVGAttributes<T> {}
