...
export interface TextCaretInputPositionerJumpLinesViewProps {
  ...
  jumpPrevLineX3TouchStartOrMouseDownDelayed: () => void; 
  ...
  jumpPrevLineX2TouchStartOrMouseDownDelayed: () => void; 
  ...
  jumpPrevLineX1TouchStartOrMouseDownDelayed: () => void; 
  ...
  jumpNextLineX1TouchStartOrMouseDownDelayed: () => void;
  ...
  jumpNextLineX2TouchStartOrMouseDownDelayed: () => void;
  ...
  jumpNextLineX3TouchStartOrMouseDownDelayed: () => void;
