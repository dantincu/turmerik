...
export default function AppSetupBar() {
  ...
  return (<AppBar sx={{ position: "relative", height: "5em" }} className={["trmrk-app-header" ].join(" ")}>
      <Button onClick={handleClick} sx={{ width: "10em", fontSize: "2em", color: "#FFF", textTransform: "none" }}>
