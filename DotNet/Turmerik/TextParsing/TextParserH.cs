...
namespace Turmerik.TextParsing
{
    public static class TextParserH
    {
        ...
        public static TextParserTemplateOpts<TNode, TArgs> WithChildrenFactory<TNode, TArgs>(
            ...
            where TArgs : TextParserTemplateArgs<TNode, TArgs> => WithChildrenFactory<TNode, TArgs, TextParserTemplateOpts<TNode, TArgs>>(
                opts, childrenFactory, rootNodesFactory);
