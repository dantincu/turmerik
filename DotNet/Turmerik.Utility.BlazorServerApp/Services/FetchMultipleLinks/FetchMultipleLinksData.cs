...
namespace Turmerik.Utility.BlazorServerApp.Services.FetchMultipleLinks
{
    ...
    {
        public static FetchMultipleLinksDataImmtbl ToImmtbl(this IFetchMultipleLinksData src) => new(src);
        public static FetchMultipleLinksDataMtbl ToMtbl(this IFetchMultipleLinksData src) => new(src);
    }
