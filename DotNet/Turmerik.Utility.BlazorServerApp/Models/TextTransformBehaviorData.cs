...
namespace Turmerik.Utility.BlazorServerApp.Models
{
    ...
    {
        public static TextTransformBehaviorDataImmtbl ToImmtbl(this ITextTransformBehaviorData src) => new(src);
        public static TextTransformBehaviorDataMtbl ToMtbl(this ITextTransformBehaviorData src) => new(src);
        public static TextTransformNodeImmtbl ToImmtbl(this ITextTransformNode src) => new(src);
        public static TextTransformNodeMtbl ToMtbl(this ITextTransformNode src) => new(src);

        public static ReadOnlyCollection<TextTransformNodeImmtbl> ToImmtblRdnlC(
            this IEnumerable<ITextTransformNode> src) => src.Select(v => v?.ToImmtbl()).RdnlC()!;

        public static List<TextTransformNodeMtbl> ToMtblList(
            this IEnumerable<ITextTransformNode> src) => src.Select(v => v?.ToMtbl()).ToList()!;

        public static TextTransformItemImmtbl ToImmtbl(this ITextTransformItem src) => new(src);
        public static TextTransformItemMtbl ToMtbl(this ITextTransformItem src) => new(src);

        public static ReadOnlyCollection<TextTransformItemImmtbl> ToImmtblRdnlC(
            this IEnumerable<ITextTransformItem> src) => src.Select(v => v?.ToImmtbl()).RdnlC()!;

        public static List<TextTransformItemMtbl> ToMtblList(
            this IEnumerable<ITextTransformItem> src) => src.Select(v => v?.ToMtbl()).ToList()!;
    }

    public class TextTransformBehaviorDataImmtbl : ITextTransformBehaviorData
    {
        public TextTransformBehaviorDataImmtbl(ITextTransformBehaviorData src)
        {
    ...
    public class TextTransformBehaviorDataMtbl : ITextTransformBehaviorData
    {
        ...
        public TextTransformBehaviorDataMtbl(ITextTransformBehaviorData src)
        {
            TextTransformers = src.GetTextTransformers()?.ToMtblList()!;
        }

        public List<TextTransformNodeMtbl> TextTransformers { get; set; } = new();
        public IEnumerable<ITextTransformNode> GetTextTransformers() => TextTransformers;
    }

    public class TextTransformNodeImmtbl : ITextTransformNode
    {
        public TextTransformNodeImmtbl(ITextTransformNode src)
        {
            Name = src.Name;
    ...
    public class TextTransformNodeMtbl : ITextTransformNode
    {
        ...
        public TextTransformNodeMtbl(ITextTransformNode src)
        {
            Name = src.Name;
            Description = src.Description;
        ...
        public List<TextTransformItemMtbl> TextTransformItems { get; set; } = new();
        public List<TextTransformItemMtbl> RichTextTransformItems { get; set; } = new();
        public List<TextTransformNodeMtbl> ChildNodes { get; set; } = new();
    ...
    {
        public TextTransformItemImmtbl(ITextTransformItem src)
        {
            Name = src.Name;
            Description = src.Description;
    ...
    public class TextTransformItemMtbl : ITextTransformItem
    {
        ...
        public TextTransformItemMtbl(ITextTransformItem src)
        {
            Name = src.Name;
            Description = src.Description;
            JsMethod = src.JsMethod;
