...
{
    public partial class NoteExplorerHcyUC : UserControl, ISidePanelUC
    {
        ...
        private void NoteExplorerHcyUC_Load(object sender, EventArgs e) => actionComponent?.Execute(
