...
{
    public partial class NoteFileExplorerHcyUC : UserControl, ISidePanelUC
    {
        ...
        private void NoteFileExplorerHcyUC_Load(object sender, EventArgs e) => actionComponent?.Execute(
