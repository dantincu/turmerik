...
{
    public partial class AppHomePageUC : UserControl, IAppPageUC
    {
        ...
        public AppHomePageUC()
        {
            ...
            if (svcProvContnr.IsRegistered)
            {
                ...
                iconLabelGoToFileExplorer.Text = MatUIIconUnicodesH.TextFormatting.FOLDER;
        ...
        private void IconLabelGoToFileExplorer_Click(object sender, EventArgs e)
        {
            openPageInCurrentTab(new AppPageOpts
            {
                Idnf = "/",
                Title = "/",
                ResourceType = AppPageResourceType.FileExplorer,
            });
        }

        private void AppHomePageUC_Load(object sender, EventArgs e) => actionComponent?.Execute(
