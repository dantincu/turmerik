...
/* harmony export */   apiSvc: () => (/* binding */ apiSvc)
/* harmony export */ });
...
class ApiService {
    ...
    init(data) {
        ...
        console.log("this.apiUriBase", this.apiUriBase);
    }
    getUri(relUri) {
    ...
    get(relUri, data) {
        return new Promise((resolve) => axios__WEBPACK_IMPORTED_MODULE_0__["default"]
            .get(this.getUri(relUri), {
            data: data,
        })
            .then((response) => {
            const resp = response;
            resp.isSuccess = this.isSuccess(resp);
            resolve(resp);
        })
            .catch((reason) => {
            const resp = {
