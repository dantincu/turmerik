...
(function (ns) {
    ...
    class ApiService {
        ...
        apiUriBase;
        clientVersion;
        defaultConfigFactory = () => undefined;
        ...
        resolvePromise(prom, resolve) {
            prom
                ...
                if (response) {
                    resp = this.setResponseFields(response);
                }
                else {
                    resp = this.getError(reason);
                }
                resolve(resp);
            });
        }
        ...
        get(relUri, data, configFactory) {
            return new Promise((resolve) => {
                this.resolvePromise(axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(this.getUri(relUri), this.getConfig(configFactory, data)), resolve);
            });
        }
        post(relUri, data, configFactory) {
            return new Promise((resolve) => {
                this.resolvePromise(axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(this.getUri(relUri), data, this.getConfig(configFactory, data)), resolve);
            });
        }
        put(relUri, data, configFactory) {
            return new Promise((resolve) => {
                this.resolvePromise(axios__WEBPACK_IMPORTED_MODULE_0__["default"].put(this.getUri(relUri), data, this.getConfig(configFactory, data)), resolve);
            });
        }
        patch(relUri, data, configFactory) {
            return new Promise((resolve) => {
                this.resolvePromise(axios__WEBPACK_IMPORTED_MODULE_0__["default"].patch(this.getUri(relUri), data, this.getConfig(configFactory, data)), resolve);
            });
        }
        delete(relUri, configFactory) {
            return new Promise((resolve) => {
                this.resolvePromise(axios__WEBPACK_IMPORTED_MODULE_0__["default"].delete(this.getUri(relUri), this.getConfig(configFactory)), resolve);
            });
        }
...
const ApiService = ns.ApiService;
...
const ApiService = _src_core__WEBPACK_IMPORTED_MODULE_0__.ApiService;
