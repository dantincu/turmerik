...
import { TrmrkDriveItemsViewService } from './trmrk-drive-items-view-service';

@Component({
  selector: 'trmrk-drive-items-view',
  imports: [
    CommonModule,
    MatButtonModule,
    MatIconModule,
  ...
  templateUrl: './trmrk-drive-items-view.html',
  providers: [TrmrkPaginatedListService],
  styleUrl: './trmrk-drive-items-view.scss',
})
export class TrmrkDriveItemsView {
  ...
  constructor(
    ...
    public service: TrmrkDriveItemsViewService,
